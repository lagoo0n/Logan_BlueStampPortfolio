...
In the future, I would hope to continue to work on projects similar to this one and carry the knowledge that I have gained while being able to use many different resources I had. This includes GitHub, and Arduino, as well as basic fundamentals of putting robots together. In the future, I hope to be an electrical engineer and by putting together this rover it has taught me a lot about the process that goes into creating anything. Going forward I hope to work on many more projects like this one and I will definitely continue to work on adding modifications to this rover.
...
# Second Milestone
After finishing building my car, I wanted to have the ability to actually control the movements. I did this by implementing the Bluetooth device provided in the kit. After plugging in the Bluetooth device, I had to hook it up to the board and then plug the Arduino in and upload the code. Then I was able to actually use my phone by connecting the device on the robot to a remote control app on my phone. I was then able to move the car in the northeast, northwest, southeast, and southwest direction and control whether the motor is on or off. It has been surprising how much I have been able to accomplish and the many different features I could add to the robot. Using an Arduino gives me a lot of freedom to implement many features. For my final milestone, I am planning on modifying the bot based on its new ability to move in any direction that I choose. 
...
The most important part of this whole project is to build the car and get the Omni wheel car to move in every direction. For my first milestone, I built up the whole car and implemented the code into the Arduino to get it to start moving. One change that I did make was that I replaced the battery pack that had originally come with the kit. This change was made as a safety precaution as the batteries that would be used in the previous battery holder were lithium batteries. A few challenges that I faced was putting the wires together. There was a lot of wiring required in order to get all the functions on the car to work. Another challenge that I faced was getting all the parts tightened on my car. I had to constantly go back to certain parts of the car, especially the wheels. My plan going forward is to make slight modifications that can utilize the car's ability to move in any direction and also be able to control where it can go on command using Bluetooth.
